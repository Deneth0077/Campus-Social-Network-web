...
export default function ContactPage() {
  ...
  const socialMedia = [
    ...
    {
      name: 'Instagram',
      link: 'https://www.instagram.com/chathuranga_nry/',
      icon: <FaInstagram className="text-2xl" />,
      description: 'Follow my visual journey and creative moments.',
      username: 'chathuranga_nry',
  ...
  const contactMethods = [
    {
      ...
      action: 'mailto:chathuranga.contact9@gmail.com',
          ...
          >
            <div className="bg-gray-50 py-12 px-6 rounded-2xl max-w-3xl mx-auto">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                href="https://chathuranga-nry.netlify.app/"
                target="_blank"
                rel="noopener noreferrer"
